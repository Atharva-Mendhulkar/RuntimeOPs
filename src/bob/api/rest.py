...
async def get_dependency_graph(
    ...
    try:
        logger.info(f"Getting dependency graph: file={file_path}, hops={hops}, direction={direction}")
...
async def batch_query(
    ...
    try:
        ...
        tasks = [
            _execute_sub_query(sub_query, claims)
            for sub_query in request.queries
        ]
