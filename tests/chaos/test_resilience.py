...
class TestDatabaseFailures:
    ...
    async def test_neo4j_failure_handling(
        self,
        test_client,
        auth_headers,
        chaos_controller
    ...
    async def test_weaviate_failure_handling(
        self,
        test_client,
        auth_headers,
        chaos_controller
...
class TestCacheFailures:
    ...
    async def test_redis_failure_handling(
        self,
        test_client,
        auth_headers,
        chaos_controller
...
class TestNetworkFailures:
    ...
    async def test_slow_database_response(
        self,
        test_client,
        auth_headers,
        chaos_controller
...
class TestCascadingFailures:
    ...
    async def test_partial_data_availability(
        self,
        test_client,
        auth_headers,
        chaos_controller
